...
function (_set_defaults_flags_cpp_linker)
    if ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
        ...
        find_program(lld_PATH "ld.lld-${llvm_major}" "ld.lld")
        if (lld_PATH)
        ...
        find_program(ar_PATH "llvm-ar-${llvm_major}" "llvm-ar")
        if (ar_PATH)
            message(STATUS "found llvm-ar: ${ar_PATH}")
            set(CMAKE_AR "${ar_PATH}" PARENT_SCOPE)
        endif ()
        find_program(ranlib_PATH "llvm-ranlib-${llvm_major}" "llvm-ranlib")
        if (ranlib_PATH)
